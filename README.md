...
# INTE1084 - m01
`Author`: Avenido, Edmar B  
`Section`: BSIT302A

## About
Creating an application that displays 10 trivias using a button.
...
Recalling what was done in OOP

## Key Takeaways
Learned how to set up the GUI and put in functions.
